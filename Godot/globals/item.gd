...
static var stat_modifiers := {
	...
	Type.SUPER_SHIELD: StatModifier.new(6, 0, false, 0, false, 1),
	Type.ULTRA_SHIELD: StatModifier.new(12, 0, false, 0, false, 2),
	Type.SUPER_ULTRA_SHIELD: StatModifier.new(24, 0, false, 0, false, 3),
...
static var descriptions := {
	...
	Type.SWORD: "+4 Damage",
	Type.WOODEN_SHIELD: "+2 Health",
	Type.IRON_SHIELD: "+3 Health",
	Type.BATTLE_HAMMER: "+1 Health\n+2 Damage",
	Type.BOOMERANG: "Can repeatedly be thrown for 2 damage.",
	Type.SUPER_SWORD: "+8 Damage",
	Type.ULTRA_SWORD: "+16 Damage",
	Type.SUPER_ULTRA_SWORD: "+32 Damage",
	Type.SUPER_BOOMERANG: "Can repeatedly be thrown for 4 damage.",
	Type.ULTRA_BOOMERANG: "Can repeatedly be thrown for 8 damage.",
	Type.SUPER_ULTRA_BOOMERANG: "Can repeatedly be thrown for 16 damage.",
	Type.SUPER_SHIELD: "+6 Health",
	Type.ULTRA_SHIELD: "+12 Health",
	Type.SUPER_ULTRA_SHIELD: "+24 Health",
	Type.SUPER_BATTLE_HAMMER: "+2 Health\n+4 Damage",
	Type.ULTRA_BATTLE_HAMMER: "+6 Health\n+6 Damage",
	Type.SUPER_ULTRA_BATTLE_HAMMER: "+10 Health\n+10 Damage",
}
